...
import selenium.PassionTeaCoWelcomePO.MENU_LINKS;
import selenium.PassionTeaCoWelcomePO.WELCOME_PAGE_IMG;

public class PassionTeaCoTest {
  // local vars
  private PassionTeaCoWelcomePO<WebElement> welcome = null;
  private static final String DATA_FILE = "src/main/resources/PassionTeaCo.json";
